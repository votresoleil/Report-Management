...
<div class="main-layout">
    ...
    <main class="main-content">
        <?php $page_title = 'Main Dashboard'; include '../dashboard/header.php'; ?>
...
document.addEventListener('click', (e) => {
    if (e.target.closest('.view-btn')) {
        ...
        if (['pdf', 'jpg', 'jpeg', 'png', 'gif', 'bmp', 'tiff', 'svg'].includes(ext)) {
            ...
            fetch(`../reports/convert_to_pdf.php?path=${encodeURIComponent(path)}`)
                .then(response => response.json())
                .then(data => {
                    if (data.pdf_path) {
                        documentPreview.src = data.pdf_path;
...
>>>>>>> 668f18a028af6f15068f7893845e8c5d742130f9:dashboard/dashboard.php
